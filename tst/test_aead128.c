...
#define AEAD128_VECTORS_FILE "vectors/aead128.txt"

// TODO add all tests, with/out AD, with/out PL, encryption and decryption

static void test_aead128_empty(void)
{
    vecs_aead128_t testcase =
            {
                    .message_len = 0,
                    .message = {0},
                    .expected_digest = {
    ...
    uint8_t obtained_digest[ASCON_AEAD128_DIGEST_SIZE] = {42};
    ascon_aead128_ctx_t aead128_ctx;

    // Without update call
    ascon_aead128_init(&aead128_ctx);
    atto_eq(aead128_ctx.buffer_len, 0);
    ascon_aead128_final(&aead128_ctx, obtained_digest);

    vecs_aead128_log(&testcase, obtained_digest);
    atto_memeq(obtained_digest,
               testcase.expected_digest,
               ASCON_AEAD128_DIGEST_SIZE);

    // With update calls of zero length
    ascon_aead128_init(&aead128_ctx);
    ascon_aead128_update(&aead128_ctx, NULL, 0);
    ascon_aead128_update(&aead128_ctx, obtained_digest, 0);
    ascon_aead128_update(&aead128_ctx, NULL, 0);
    ascon_aead128_final(&aead128_ctx, obtained_digest);
...
static void test_aead128_1_byte(void)
{
    vecs_aead128_t testcase =
            {
                    .message_len = 1,
    ...
    ascon_aead128_init(&aead128_ctx);
    ascon_aead128_update(&aead128_ctx, testcase.message, testcase.message_len);
    atto_eq(aead128_ctx.buffer_len, 1);
    ascon_aead128_final(&aead128_ctx, obtained_digest);
...
static void test_aead128_2_bytes(void)
{
    vecs_aead128_t testcase =
            {
                    .message_len = 2,
    ...
    ascon_aead128_init(&aead128_ctx);
    ascon_aead128_update(&aead128_ctx, testcase.message, testcase.message_len);
    atto_eq(aead128_ctx.buffer_len, testcase.message_len % ASCON_RATE);
    ascon_aead128_final(&aead128_ctx, obtained_digest);
    ...
    ascon_aead128_init(&aead128_ctx);
    ascon_aead128_update(&aead128_ctx, &testcase.message[0], 1);
    atto_eq(aead128_ctx.buffer_len, 1);
    ascon_aead128_update(&aead128_ctx, &testcase.message[1], 1);
    atto_eq(aead128_ctx.buffer_len, 2);
    ascon_aead128_final(&aead128_ctx, obtained_digest);
...
static void test_aead128_7_bytes(void)
{
    vecs_aead128_t testcase =
            {
                    .message_len = 7,
    ...
    {
        ascon_aead128_update(&aead128_ctx, &testcase.message[i], 1);
        atto_eq(aead128_ctx.buffer_len, (i + 1) % ASCON_RATE);
    }
    ascon_aead128_final(&aead128_ctx, obtained_digest);
...
static void test_aead128_8_bytes(void)
{
    vecs_aead128_t testcase =
            {
                    .message_len = 8,
...
static void test_aead128_9_bytes(void)
{
    vecs_aead128_t testcase =
            {
                    .message_len = 9,
...
static void test_aead128_15_bytes(void)
{
    vecs_aead128_t testcase =
            {
                    .message_len = 15,
...
static void test_aead128_16_bytes(void)
{
    vecs_aead128_t testcase =
            {
                    .message_len = 16,
...
static void test_aead128_33_bytes(void)
{
    vecs_aead128_t testcase =
            {
                    .message_len = 33,
...
static void test_aead128_batch(void)
{
    vecs_ctx_t ctx;
    vecs_aead128_t testcase;
    uint8_t obtained_digest[ASCON_AEAD128_DIGEST_SIZE];
    vecs_err_t errcode = vecs_init(&ctx, AEAD128_VECTORS_FILE);
    atto_eq(errcode, VECS_OK);

    while (1)
    {
        errcode = vecs_aead128_next(&ctx, &testcase);
        if (errcode == VECS_EOF)
        {
            break;
        }
        atto_eq(errcode, VECS_OK);
        ascon_aead128(obtained_digest, testcase.message, testcase.message_len);
        vecs_aead128_log(&testcase, obtained_digest);
        atto_memeq(obtained_digest,
                   testcase.expected_digest,
                   ASCON_AEAD128_DIGEST_SIZE);
...
static void test_aead128_update_single_byte(void)
{
    vecs_ctx_t ctx;
    vecs_aead128_t testcase;
    uint8_t obtained_digest[ASCON_AEAD128_DIGEST_SIZE];
...
void test_aead128(void)
{
    test_aead128_empty();
    test_aead128_1_byte();
    test_aead128_2_bytes();
    test_aead128_7_bytes();
    test_aead128_8_bytes();
    test_aead128_9_bytes();
    test_aead128_15_bytes();
    test_aead128_16_bytes();
    test_aead128_33_bytes();
    test_aead128_batch();
    test_aead128_update_single_byte();
}
